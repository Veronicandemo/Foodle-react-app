        ...
        <div className="flex flex-col space-y-7">
          ...
          <div className="flex items-center  gap-4">
            ...
            <p className="text-lightGrey whitespace-pre text-[18px] font-medium">
              We Are Just A Click Away When You <br /> Crave For Delicious Fast
              Food
            </p>
          </div>
          <div className="flex items-center gap-10">
            ...
            <p className="text-darkGrey text-xl font-semibold">How to order</p>
          </div>
        </div>

        <div>
          <img src="./public/sandwich.png" />
        </div>
      </div>

      <div className="absolute left-24 top-[30rem] flex h-40  items-center justify-between gap-10 rounded-3xl bg-slate-50 p-8">
